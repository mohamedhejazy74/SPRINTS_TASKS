 ...
 */
extern Std_ReturnType TIMER_MANGER_init(const TimerManger_config_t *stPtr_a_TimerConfig);
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMER_MANGER_start(const TimerClock_t en_a_timer_clock,const TimerType_t en_a_timer_num);
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMER_MANGER_stop(const TimerType_t en_a_timer_num);
