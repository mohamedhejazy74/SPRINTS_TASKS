 ...
 */
extern Std_ReturnType TIMERx_init(const Timer_Config_t *stPtr_a_Config);
/*
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMERx_start(const TimerClock_t en_a_timer_clk,const TimerType_t en_a_timer_type);
/*
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMERx_setCallBack( void(*a_fptr)(void), const TimerType_t en_a_timer_type );
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMERx_setValue(const TimerType_t en_a_timer_type ,const uint16_t u16_a_timer_value);
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMERx_CTC_SetCompare(const TimerType_t en_a_timer_type ,const uint16_t u16_a_compareValue);
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMERx_reset(const TimerType_t en_a_timer_type);
...
* E_NOT_OK :the function has issues performing the function
*/
extern Std_ReturnType TIMERx_stop(const TimerType_t en_a_timer_type);
