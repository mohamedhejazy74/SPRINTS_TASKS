...
typedef struct{
	enu_port_index_t port ;        /* @ref port_index_t*/
	enu_pin_index_t  pin  ;         /* @ref pin_index_t*/
}enu_pin_config_t;
...
* E_NOT_OK :the function has issues performing the function
*/
Std_ReturnType DIO_pin_toggle_logic(const enu_pin_config_t *pin_config_ptr);
/**
...
* E_NOT_OK :the function has issues performing the function
*/
Std_ReturnType DIO_port_direction_intialize(const enu_port_index_t a_port_index, uint8_t a_direction);
/**
* @param port_index
* @param logic
* @return status of the function
...
* E_NOT_OK :the function has issues performing the function
*/
Std_ReturnType DIO_port_write_logic(const enu_port_index_t a_port_index , uint8_t a_logic);
/**
* @param port_index
* @param logic
* @return status of the function
...
* E_NOT_OK :the function has issues performing the function
*/
Std_ReturnType DIO_port_read_logic(const enu_port_index_t a_port_index , uint8_t *const a_logic_ptr);
/**
* @param port_index
* @return status of the function
* E_OK :the function done successfully
* E_NOT_OK :the function has issues performing the function
*/
Std_ReturnType DIO_port_toggle_logic(const enu_port_index_t a_port_index);
